...
namespace Interpreter.Expressions.Operators
{
    class AddExpression : IExpression
    {
        ...
        public object Run(Context context)
        {
            ...
            if (firstOperandObj is string || secondOperandObj is string)
                return firstOperandObj.ToString() + secondOperandObj.ToString();
            else if (firstOperandObj is double || secondOperandObj is double)
            {
